        ...
        <table width="540" border="0" align="center" cellpadding="0" cellspacing="0" class="body">
          <tr> 
                ...
                <tr> 
                  ...
                  <td>
                    <select name="default_skin">
                        <option value="mw.basic.1"> 1세대 </option>
                        <option value="mw.basic.2"> 2세대 </option>
                        <option value="mw.basic.3"> 3세대 </option>
                    </select>
                    </td>
                </tr>
              </table> 
            ...
            <td><strong>최고관리자 정보입력</strong> <br>
              ...
              <table width="270" border="0" cellpadding="0" cellspacing="0" class="body">
                <tr> 
                  <td width="80" align="right" height=30>자동생성 :&nbsp;</td>
                  <td>
                    <input type="checkbox" name="no_board" value="1">메뉴 및 게시판 자동생성 안함
                    </td>
                </tr>
              </table> 
            </td>
