...
// 버그신고 및 프로그램 개발문의 : kcho07@nate.com
  ...
  $today_max = 1000; // 하루에 게임가능 건수

  $min_point = 2000; // 회원이 설정값이상 보유하고 있어야 게임이 가능

  // 게임명
  $game_name = "포인트 걸고 가위바위보 게임!!!!!!";
 ...
 if ($sprgame_mode ==1) {
   ...
   $game_point_bglose = 30; //비겼을 경우 차감포인트
   $game_point_bglosename = '30'; //비겼을 경우 잃는 포인트설명
   ...
   $game_point = rand(300,3000); //이겼을 경우 받는 포인트
   $game_pointname = '300~3,000'; //이겼을 경우 받는 포인트설명
