...
<table width="<?=$width?>" align="center" cellpadding="0" cellspacing="0">
    <tr>
	    <td height="34" style="clear:both; height:34px; background:url(<?=$board_skin_path?>/img/title_bg.gif) repeat-x;"><div style="font-weight:bold; font-size:14px; margin:7px 0 0 10px;">:: <?=$title_msg?> ::</div></td></tr>
    <tr>
...
?>
			    ...
			    <textarea id="wr_content" name="wr_content" class="tx" style='width:100%; word-break:break-all;' rows="20" itemname="내용" 
				...
				<? if ($is_file) { ?>
				<tr>
				    <td class="write_head">&middot; 대표이미지 
                                        <div class=write_size>size  </div></td>
	...
	<input class=ed type="file" name='bf_file[0]'>
                                ...
                                <tr><td class=write_head>&middot; 부가 이미지1 
                                        <div class=write_size>size  </div></td>
                                    <td class=write_main bgcolor="#ffffff"">
         <input class=ed type="file" name='bf_file[1]'>
                                ...
                                <tr><td class=write_head width="201">&middot; 부가 이미지2 
                                        <div class=write_size>size  </div></td>
                                    <td class=write_main bgcolor="#ffffff">
          <input class=ed type="file" name='bf_file[2]'>
                                ...
                                <tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
                                <tr><td class=write_head width="201">&middot; 부가 이미지3 
                                        <div class=write_size>size  </div></td>
                                    <td class=write_main bgcolor="#ffffff">
        <input class=ed type="file" name='bf_file[3]'>
                                ...
                                <tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
                                <tr><td class=write_head width="201">&middot; 부가 이미지4 
                                        <div class=write_size>size  </div></td>
                                    <td class=write_main bgcolor="#ffffff">
         <input class=ed type="file" name='bf_file[4]'>
                                ...
                                <tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
                                <tr><td class=write_head width="201">&middot; 부가 이미지5 
                                        <div class=write_size>size  </div></td>
                                    <td class=write_main bgcolor="#ffffff">
        <input class=ed type="file" name='bf_file[5]'>
                                ...
                                <tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
                                <tr><td class=write_head width="201">&middot; 부가 이미지6 
                                        <div class=write_size>size  </div></td>
                                    <td class=write_main bgcolor="#ffffff">
         <input class=ed type="file" name='bf_file[6]'>
								...
								<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
                                <tr><td class=write_head width="201">&middot; 부가 이미지7 
                                        <div class=write_size>size  </div></td>
                                    <td class=write_main bgcolor="#ffffff">
         <input class=ed type="file" name='bf_file[7]'>
                                ...
                                <tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
                                <tr><td class=write_head width="201">&middot; 부가 이미지8 
                                        <div class=write_size>size  </div></td>
                                    <td class=write_main bgcolor="#ffffff">
         <input class=ed type="file" name='bf_file[8]'>
                                ...
                                <tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
                                <tr><td class=write_head width="201">&middot; 부가 이미지9 
                                        <div class=write_size>size</div></td>
                                    <td class=write_main bgcolor="#ffffff">
