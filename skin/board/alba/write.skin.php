...
<div style="font-weight:bold; font-size:14px; margin-top:7px; margin-right:0; margin-bottom:0; margin-left:10px;">:: <?=$title_msg?> ::</div>
</div>
...
<tr>
    <td class=write_head>이 름</td>
    <td><input class='ed' maxlength=20 size=20 name=wr_names itemname="이름" required value="<?=$write[wr_name]?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>

<tr>
	<td class=write_head>날 짜</td>
    <td><input class='ed' maxlength=20 size=20 name=wr_datetime itemname="날짜" required value="<?=$write[wr_datetime]?>">  ※ 2013-01-09 00:00:00 형태로 입력</td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>

<tr>
	<td class=write_head>조 회</td>
    <td><input class='ed' maxlength=20 size=20 name=wr_hit itemname="조회" required value="<?=$write[wr_hit]?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
...
<tr>
    ...
    <td><select name=ca_name required itemname="분류"><option value="">선택하세요<?=$category_option?></option>
</select></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<? } ?>
...
<tr>
    ...
    <td><input class='ed' size=75 name=wr_subject id="wr_subject" itemname="제목" required value="<?=$subject?>"></td></tr>
	<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
	<tr><td class="write_head">업   종</td>
	<td><input class='ed' maxlength=10 size=20 name="wr_1" itemname="조회" required value="<?=$write[wr_1]?>"></td>
                    </tr>
					<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
                    <tr>
                        <td class="write_head">업무시간</td>
                        <td ><input class='ed' maxlength=20 size=20 name="wr_2" itemname="조회" required value="<?=$write[wr_2]?>"></td></tr>
						<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
						<tr><td  class="write_head">급 여 액</td>
                        <td ><input class='ed' maxlength=20 size=20 name="wr_3" itemname="조회" required value="<?=$write[wr_3]?>"></td>
                    </tr>
					<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
					<tr>
                        <td height="7" class="write_head">연 락 처</td>
                        <td height="23"><p><input type="text" name="etc4_exp00" size="3" class=ed style="ime-mode:active" value="<?=$etc4_exp[0]?>" required maxlength="3">
-<input class=ed name="etc4_exp01" size="4" class='simpleform' style="ime-mode:active" value="<?=$etc4_exp[1]?>" maxlength="4" required>
-<input class=ed name="etc4_exp02" size="4" class='simpleform' style="ime-mode:active" value="<?=$etc4_exp[2]?>" maxlength="4" required>
</p></td>
                    </tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
