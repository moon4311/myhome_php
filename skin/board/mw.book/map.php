...
// 네이버 지도api 키값 
//$map_key = "key=d3f107c2a69c50e5e21db36bf8ef84b3"; 
...
$address = substr($view[wr_10], 8); // 3번 여유 필드에 저장 되어 있는 주소의 우편번호를 삭제 
...
<!-- 네이버 지도 키 값 --> 
<SCRIPT LANGUAGE="JavaScript" src="http://map.naver.com/js/naverMap.naver?key=1키값f"></SCRIPT> 
<!-- 네이버 지도 키 값 끝 --> 
...
var icon = new NIcon("<?=$board_skin_path?>/img/map_icon.gif", new NSize(25,25)); // 아이콘파일을 계정에 만드시고(지정된 위치에 표시되는 아이콘입니다) 이미지 주소 및 크기를 변경해주세요 
