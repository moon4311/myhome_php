	...
	areas['시/도'] = '포항시 남구,포항시 북구,경주시,영덕군,울릉군,울진군,영천시';
	...
	areas['포항시 남구'] = '괴동동,대도동,대잠동,동촌동,상도동,송내동,송도동,이동,인덕동,일월동,장흥동,지곡동,청림동,해도동,호동,효자동,구룡포읍,연일읍,유강리,오천읍,문덕리,대송면,동해면,장기면,호미곶면';
	areas['포항시 북구'] = '남빈동,대신동,대흥동,덕산동,덕수동,동빈1가,동빈2가,두호동,득량동,상원동,신흥동,양덕동,여남동,여천동,용흥동,우현동,장성동,죽도동,중앙동,창포동,학산동,학잠동,항구동,환호동,흥해읍,기계면,기북면,송라면,신광면,죽장면,청하면';
