...
<td align=center width="69">상세정보</td> 

<td width="459"> 
<table width=100%> 
<tr> 
    <td align="right" width="14%"><p align="center">지은이</p> </td>
    <td  width="32%"><INPUT class=ed style="width:100%;" name=wr_1 itemname="강의명" required value="<?=$write[wr_1]?>"></td> 
    <td  width="15%" align="right"><p align="center">출판사</p></td>
    <td width="36%"><INPUT class=ed style="width:100%;" name=wr_2 itemname="지은이" required value="<?=$write[wr_2]?>"></td> 
</tr> 
<tr> 
   <td align="right" width="14%"><p align="center">발행일</p></td>
    <td  width="32%"><INPUT class=ed style="width:100%;" name=wr_3 itemname="출판사" required value="<?=$write[wr_3]?>"></td> 
    <td width="15%" align="right"><p align="center">원  가</p></td>
    <td width="36%"><INPUT class=ed style="width:100%;" name=wr_4 itemname="발행일" required value="<?=$write[wr_4]?>"></td>
</tr>
<tr> 
    <td align="right" width="14%"><p align="center" colspan="2">판매가</p></td>
    <td  width="32%"><INPUT class=ed style="width:100%;" name=wr_5 itemname="출판사" required value="<?=$write[wr_5]?>"></td> 
...
<tr><td height="1" background="<?=$board_skin_path?>/img/dot_bg.gif" colSpan="2" width="567"></td></tr> 

                    <tr>

    <td align="center" width="69">내용</td> 

                        <td style='padding:5px;' width="449">
                            <? if ($is_dhtml_editor) { ?>
                ...
                <SPAN style="CURSOR: pointer;" onclick="textarea_increase('content_a', 10);"><img src="<?=$board_skin_path?>/img/down.gif" width="16" height="16"></SPAN></td>
                            ...
                            <p><textarea id="wr_content" name="wr_content" class=tx style='width:100%; word-break:break-all;' rows=10 itemname="내용" required 
        <? if ($write_min || $write_max) { ?>onkeyup="check_byte('wr_content', 'char_count');"<?}?>><?=$content?></textarea><? if ($write_min || $write_max) { ?>
                            <script language="JavaScript">
check_byte('content_a', 'char_count'); 
                            </script>
                            <?}?></p>
                        </td>
		 <? } ?>
