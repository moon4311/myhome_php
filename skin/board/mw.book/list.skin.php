...
<tr class=mw_basic_list_title>
    ...
    <? if (!$mw_basic[cf_post_name]) { ?> <? if ($mw_basic[cf_attribute] != "anonymous") { ?> <td width=95>출판사</td> <?}?> <?}?>
    <? if ($mw_basic[cf_attribute] == "qna") { ?> <td width=50>상태</td> <?}?>
    <? if ($mw_basic[cf_attribute] == "qna" && $mw_basic[cf_qna_point_use]) { ?> <td width=40>포인트</td> <?}?>
    <? if (!$mw_basic[cf_post_date]) { ?> <td width=50>판매가</td> <?}?>
...
<tr align=center <? if ($list[$i][is_notice]) echo "bgcolor='#f8f8f9'"; ?>>
    ...
    <? if ($mw_basic[cf_attribute] != "anonymous") { ?> <td><nobr class=mw_basic_list_name><?=$list[$i][wr_2]?></nobr></td> <?}?> <?}?>
    ...
    <? if (!$mw_basic[cf_post_date]) { ?> <td class=mw_basic_list_datetime><?=$list[$i][wr_5]?></td> <?}?>
