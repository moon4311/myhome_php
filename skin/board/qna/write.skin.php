...
if ($is_admin) 
{
    ...
    if (typeof(document.fwrite.ca_name) != 'undefined')
    {
        ...
        document.fwrite.ca_name.options[document.fwrite.ca_name.options.length-1].value = '공지사항';
        document.fwrite.ca_name.options[document.fwrite.ca_name.options.length-1].text = '공지사항';
    }";
} 
?>
