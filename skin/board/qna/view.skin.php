	    ...
	    <td>		
		    ...
		    <table border="0" cellpadding="0" cellspacing="0" width="100%">
		        <tr>
		            ...
		            <? if ($is_good) { ?>&nbsp;<img src="<?=$board_skin_path?>/img/icon_good.gif" border='0' align=absmiddle> 추천 : <span style=font-size:8pt;><?=number_format($view[wr_good])?></span><? } ?>
		            <? if ($is_nogood) { ?>&nbsp;<img src="<?=$board_skin_path?>/img/icon_nogood.gif" border='0' align=absmiddle> 비추천 : <span style=font-size:8pt;><?=number_format($view[wr_nogood])?></span><? } ?>&nbsp;
		            </div>
		            </td>
				</tr>
				    <?
