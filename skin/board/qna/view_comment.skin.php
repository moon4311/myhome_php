        ...
        <tr>
            <td valign="top">
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td width="60%" align="left" style="padding:5px 0 0 8px;">
                        ...
                        <td width="40%" align="right" style="padding:5px 8px 0 0;">
...
<table width="100%" cellpadding="8" cellspacing="0">
    ...
    <td width=83 align=left style="padding:8px 8px 8px 0px;"><input type="image" src="<?=$board_skin_path?>/img/ok_btn.gif" border=0 accesskey='s'></td>
    </tr>
</table>
</form>
