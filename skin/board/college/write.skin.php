...
<tr>
    <td class=write_head>전 공 명</td>
    <td><input class='ed' style="width:80%;" name=wr_subject id="wr_subject" itemname="제목" required value="<?=$subject?>"></td></tr>
                    <tr>
                        <td height="7" class="write_head">과목코드</td>
                        <td height="23"><input class='ed' maxlength=10 size=20 name="wr_1" itemname="조회" required value="<?=$write[wr_1]?>"></td>
                    </tr>
                    <tr>
                        <td height="7" class="write_head">담당교수</td>
                        <td height="23"><input class='ed' maxlength=10 size=20 name="wr_2" itemname="조회" required value="<?=$write[wr_2]?>"></td>
                    </tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
