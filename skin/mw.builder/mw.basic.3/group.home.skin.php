...
<tr>
	...
	<div class="latest-block"><?=mw_latest_tab("mw.tab", "B05, B06, B14", 5, 32, $group[gr_cache])?></div>
	<div class="latest-block"><?=mw_latest_rand("mw.side2.list", "B13", 10, 35, 0, $group[gr_cache])?></div>
	&nbsp;
    </td>
</tr>
<tr>
