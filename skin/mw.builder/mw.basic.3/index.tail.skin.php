...
<div class="mw-banner"><!--130에 30이 원래 크기-->
<span><a href="http://www.suncheon.go.kr/kr/" target=_blank><img src="<?=$mw_index_skin_tail_path?>/img/b1.gif"></a></span>

<span><a href="http://www.nolowa.kr/" target=_blank><img src="<?=$mw_index_skin_tail_path?>/img/b2.gif" ></a></span>

<span><a href="http://www.scgardens.or.kr/" target="_blank"><img src="<?=$mw_index_skin_tail_path?>/img/b3.png"></a></span>

<span><a href="#" target=_blank><img src="<?=$mw_index_skin_tail_path?>/img/banner-tail.gif"></a></span>

<span><a href="http://www.rich-asset.co.kr/" target=_blank><img src="<?=$mw_index_skin_tail_path?>/img/rich.png" width="125" height="32"></a></span>

<span><a href="http://point.miwit.com/plugin/inban/click.php?mb_id=kjm4311&id=1" target="_blank"><img src="http://point.miwit.com/plugin/inban/banner.php?mb_id=kjm4311&id=1" width="130" height="30" border="0"></a></span>
</div>
