...
// 오늘의 횟수를 체크
$sql = " select count(*) as cnt from $taja_table where mb_id = '$_POST[mb_id]' and taja_datetime like '$g4[time_ymd]%' ";
...
$taja_table = $g4['table_prefix'] . "taja";
...
insert_point($_POST[mb_id], $point, "게임 - 타자하기", "taja", "$g4[server_time]", "타자하기");

$sql = " insert into $taja_table set taja_point = '$prnSpeedCur', taja_datetime='$g4[time_ymdhis]', mb_id = '$_POST[mb_id]' ";
sql_query($sql);
